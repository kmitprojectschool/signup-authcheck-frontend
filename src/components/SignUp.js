...
let submitHandler = async (e) => {
    e.preventDefault();
    console.log(" hey" +requsername+' '+reqpassword);

    //call middleware api to store in db
    try {
            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <div className="d-flex flex-row align-items-center mb-4">
                    <i className="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div className="form-outline flex-fill mb-0">
                      <input type="text" id="form3Example1c" onChange={(e) => setUsername(e.target.value)} className="form-control" />
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4c" onChange={(e) => setPassword(e.target.value)}  className="form-control" />
